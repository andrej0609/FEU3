...
let image = "https://cdn.britannica.com/24/189624-050-F3C5BAA9/Mona-Lisa-oil-wood-panel-Leonardo-da.jpg";

for (let i = 0; i < 1; i++) {
  task1.innerHTML += `
    <div>
      <h1 class = "title">${title}</h1>
      <p class = "par1">${paragraph}</p>
      <img class = "monaLisa" src="${image}" />
    </div>
  `;
}
...
let title2 = "Leonardo da Vinci paintings";
let images = [
...
let title3 = "Works of Greatests of Artists";
let imagesTitles = ["Mona Lisa", "Last Supper", "Lady With An Ermine", "David", "The Creation of Adam", "Venus de Milo"];
let imagess = [
  "https://cdn.britannica.com/24/189624-050-F3C5BAA9/Mona-Lisa-oil-wood-panel-Leonardo-da.jpg",
  "https://cdn.britannica.com/04/95904-050-7EB39FC8/Last-Supper-wall-painting-restoration-Leonardo-da-1999.jpg",
  "https://www.leonardodavinci.net/images/gallery/lady-with-an-ermine.jpg",
...
for (let i = 0; i < paragraphs.length; i++) {
  task3.innerHTML += `
    <div>
      <h2 class = "namesOfWorks">${imagesTitles[i]}</h2>
    </div>
    <div>
      <p>${paragraphs[i]}</p>
      <img class = "images" src="${imagess[i]}" />
    </div>
  `;
}